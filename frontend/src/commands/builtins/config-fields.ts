...
export const CONFIG_FIELDS: FieldDef[] = [
  ...
  { key: 'open_press_count', labelKey: 'open_press_count', kind: 'enum',
    choices: () => [{ label: '2', value: '2' }, { label: '3', value: '3' }] },
  ...
  { key: 'close_press_count', labelKey: 'close_press_count', kind: 'enum',
    choices: () => [{ label: '2', value: '2' }, { label: '3', value: '3' }] },
